...
const NotProsumerCommercialFlow: React.FC<Props> = ({ onBack }) => {
    ...
    return (
      <div className="space-y-8 animate-fadeIn max-w-4xl mx-auto pb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-emerald-600 p-6 rounded-3xl border border-emerald-700 shadow-xl text-center text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-slate-900 p-6 rounded-3xl text-white shadow-xl flex flex-col justify-center">
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              ...
              <div><p className="text-slate-500 text-[8px] font-black uppercase mb-1">CO2 Evitado</p><p className="text-xl font-bold text-emerald-400">{(results.EG * 0.041).toFixed(2)} <span className="text-[10px] font-normal text-slate-400">kg</span></p></div>
              <div><p className="text-slate-500 text-[8px] font-black uppercase mb-1">Árboles eq.</p><p className="text-xl font-bold text-blue-400">{Math.ceil((results.EG * 0.041) / (10/12))}</p></div>
            </div>
          </div>
        </div>
          ...
          {showAux && (
            <div className="p-8 border-t bg-slate-50 space-y-4 text-[11px] font-mono text-slate-600 leading-relaxed text-left">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-2">
                ...
                <div className="flex justify-between border-b pb-1 bg-emerald-50 p-1 rounded"><span>Total Energía, con (Suma - Recon.):</span> <span className="font-bold text-emerald-700">{formatCurrency(results.totalEnergiaCon)}</span></div>
  ...
  return (
    <div className="space-y-8 animate-fadeIn max-w-4xl mx-auto pb-20">
      ...
      <div className="bg-emerald-600 p-6 rounded-3xl text-white flex items-center justify-between shadow-xl">
          ...
          <div>
            ...
            <div className="flex gap-8 mt-4">
              <label className="flex items-center space-x-3 cursor-pointer group">
                ...
                />
                <span className="text-sm font-bold text-slate-600 group-hover:text-emerald-600 transition-colors uppercase italic">Sí</span>
              </label>
              <label className="flex items-center space-x-3 cursor-pointer group">
                <input 
                  type="radio" 
                ...
                />
                <span className="text-sm font-bold text-slate-600 group-hover:text-emerald-600 transition-colors uppercase italic">No</span>
              </label>
            </div>
          </div>
          ...
          {formData.knowsPower === 'si' && (
            <div className="animate-fadeIn">
              ...
              <input 
                ...
                placeholder="Ej: 3.3" 
              />
              <p className="text-[10px] text-slate-400 mt-2 font-bold uppercase italic border-l-2 border-emerald-200 pl-3">
