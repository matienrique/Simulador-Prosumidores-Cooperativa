...
const NotProsumerResidentialFlow: React.FC<Props> = ({ onBack }) => {
    ...
    return (
      <div className="space-y-8 animate-fadeIn max-w-4xl mx-auto pb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-blue-600 p-6 rounded-3xl border border-blue-700 shadow-xl text-center text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-3xl border border-slate-200">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden"><div className="bg-emerald-500 h-full" style={{width: `${safeDiv(results.ER, results.EG) * 100}%`}}></div></div>
              </div>
            </div>
          </div>
          <div className="bg-slate-900 p-6 rounded-3xl text-white shadow-xl flex flex-col justify-center">
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              ...
              <div><p className="text-slate-500 text-[8px] font-black uppercase mb-1">CO2 Evitado</p><p className="text-xl font-bold text-blue-400">{(results.EG * 0.041).toFixed(2)} <span className="text-[10px] font-normal text-slate-400">kg</span></p></div>
          ...
          {showAux && (
            <div className="p-8 border-t bg-slate-50 space-y-4 text-[11px] font-mono text-slate-600 leading-relaxed text-left">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-2">
                ...
                <div className="flex justify-between border-b pb-1"><span>Reconocimiento GSF (20,93 * ER):</span> <span className="font-bold text-slate-900">{formatCurrency(results.reconGSF)}</span></div>
                <div className="flex justify-between border-b pb-1 bg-blue-50 p-1 rounded"><span>Total Energía, con (Suma - Recon.):</span> <span className="font-bold text-blue-700">{formatCurrency(results.totalEnergiaCon)}</span></div>
  ...
  return (
    <div className="space-y-8 animate-fadeIn max-w-4xl mx-auto pb-20">
      ...
      <div className="bg-blue-600 p-6 rounded-3xl text-white flex items-center justify-between shadow-xl">
          ...
          <div>
            ...
            <div className="flex gap-8 mt-4">
              <label className="flex items-center space-x-3 cursor-pointer group">
                ...
                />
                <span className="text-sm font-bold text-slate-600 group-hover:text-blue-600 transition-colors uppercase italic">Sí</span>
              </label>
              <label className="flex items-center space-x-3 cursor-pointer group">
                <input 
                  type="radio" 
                ...
                />
                <span className="text-sm font-bold text-slate-600 group-hover:text-blue-600 transition-colors uppercase italic">No</span>
              </label>
            </div>
          </div>
          ...
          {formData.knowsPower === 'si' && (
            <div className="animate-fadeIn">
              ...
              <input 
                ...
                placeholder="Ej: 3.3" 
              />
              <p className="text-[10px] text-slate-400 mt-2 font-bold uppercase italic border-l-2 border-blue-200 pl-3">
